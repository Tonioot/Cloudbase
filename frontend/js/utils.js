...
export const icon = {
  ...
  chevronL:  `<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><polyline points="15,18 9,12 15,6"/></svg>`,
  ...
  info:      `<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="10" x2="12" y2="16"/><line x1="12" y1="7" x2="12.01" y2="7"/></svg>`,
  ...
  return new Promise(resolve => {
    ...
    backdrop.innerHTML = `
      <div class="dialog">
        ...
        <div class="dialog-body" style="color:var(--text-secondary);font-size:13px;line-height:1.5">${body}</div>
...
export function prompt(title, label, initialValue = '') {
  return new Promise(resolve => {
    const backdrop = document.createElement('div');
    backdrop.className = 'dialog-backdrop';
    backdrop.innerHTML = `
      <div class="dialog">
        ...
        <div class="dialog-body">
          ...
          <input type="text" class="input" id="prompt-input" style="width:100%" value="${initialValue}" autofocus />
        </div>
        <div class="dialog-actions">
          <button class="btn btn-secondary" id="prompt-cancel">Cancel</button>
          <button class="btn btn-primary" id="prompt-ok">Save Changes</button>
        </div>
      </div>`;
    document.body.appendChild(backdrop);
    ...
    backdrop.querySelector('#prompt-ok').onclick = () => finish(input.value.trim());
    input.onkeydown = (e) => {
